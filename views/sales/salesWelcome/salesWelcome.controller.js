(function () {
    ...
    angular
        .module('app')
        .controller('salesWelcome', salesWelcome);

    salesWelcome.$inject = ['$http', '$scope','$location','$timeout','$rootScope'];
    function salesWelcome($http, $scope,$location,$timeout,$rootScope){
        var vm = this;
        $rootScope.menu = {
            'display' : "none"
        };
